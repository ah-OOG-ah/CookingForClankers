...
- [x] Create a schedule for tasks and class presentations.
  ...
  - 3/19: [Milestone 2](#milestone-2---supervisor-update)
    - 3/3: [Task 3](#-task-3-styling-the-site-with-css)
    - 3/5: [Task 4](#-task-4-recipe-details-page)
    - 3/10: [Task 5](#-task-5-improving-user-interface-with-animation)
    - 3/12: [Task 6](#-task-6-adding-javascript-for-dynamic-recipe-listings)
    - 3/17: [Task 7](#-task-7-search-functionality)
