...
- [x] Create a schedule for tasks and class presentations.
  ...
  - 4/13: [Milestone 2](#milestone-2---supervisor-update)
    - 3/19: [Task 3](#-task-3-styling-the-site-with-css)
    - 3/24: [Task 4](#-task-4-recipe-details-page)
    - 4/12: [Task 5](#-task-5-improving-user-interface-with-animation)
    - 4/13: [Task 6](#-task-6-adding-javascript-for-dynamic-recipe-listings)
    - 4/13: [Task 7](#-task-7-search-functionality)
  - 4/20: [Milestone 3](#milestone-3---uxui-report)
